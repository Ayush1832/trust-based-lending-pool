...
const Deposit = ({ account, web3, setError }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-3xl font-extrabold text-white mb-6">Deposit</h2>
        <input
          type="number"
          value={amount}
